...
- **Ecwid / CTAs** — Product IDs and optional product page URLs live in **`src/config/ecwid.js`** and env (`VITE_*`); updating images does not change Ecwid, but new products must still be wired there when they go live.
